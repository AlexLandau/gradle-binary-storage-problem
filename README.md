Repro of the "Problems reading data from Binary store"/"Corrupt serialized resolution result" bug in Gradle dependency management. Gradle version used is 7.3.

Run:

```
./gradlew :outer-project:lib:dependencies --configuration=compileClasspath --stacktrace
```

Get:

```
> Task :outer-project:lib:dependencies FAILED

------------------------------------------------------------
Project ':outer-project:lib'
------------------------------------------------------------
...
* What went wrong:
Execution failed for task ':outer-project:lib:dependencies'.
> Could not resolve all dependencies for configuration ':outer-project:lib:compileClasspath'.
   > Problems reading data from Binary store in /Users/username/.gradle/.tmp/gradle6510710039750689770.bin offset 0 exists? true
...
* Exception is:
org.gradle.api.tasks.TaskExecutionException: Execution failed for task ':outer-project:lib:dependencies'.
...
Caused by: org.gradle.api.artifacts.ResolveException: Could not resolve all dependencies for configuration ':outer-project:lib:compileClasspath'.
        ...
        at org.gradle.api.internal.artifacts.configurations.DefaultConfiguration$ConfigurationResolvableDependencies$LenientResolutionResult.getRoot(DefaultConfiguration.java:1813)
        at org.gradle.api.tasks.diagnostics.internal.dependencies.AsciiDependencyReportRenderer.render(AsciiDependencyReportRenderer.java:97)
        at org.gradle.api.tasks.diagnostics.AbstractDependencyReportTask.generate(AbstractDependencyReportTask.java:66)
        at org.gradle.api.tasks.diagnostics.ProjectBasedReportTask.lambda$generate$0(ProjectBasedReportTask.java:42)
        at org.gradle.api.tasks.diagnostics.internal.ReportGenerator.generateReport(ReportGenerator.java:76)
        at org.gradle.api.tasks.diagnostics.internal.ReportGenerator.generateReport(ReportGenerator.java:56)
        at org.gradle.api.tasks.diagnostics.ProjectBasedReportTask.generate(ProjectBasedReportTask.java:39)
        ...
        at org.gradle.internal.concurrent.ManagedExecutorImpl$1.run(ManagedExecutorImpl.java:48)
        at org.gradle.internal.concurrent.ThreadFactoryImpl$ManagedThreadRunnable.run(ThreadFactoryImpl.java:61)
Caused by: java.lang.RuntimeException: Problems reading data from Binary store in /Users/username/.gradle/.tmp/gradle6510710039750689770.bin offset 0 exists? true
        ...
        at org.gradle.internal.concurrent.ManagedExecutorImpl$1.run(ManagedExecutorImpl.java:48)
        at org.gradle.internal.concurrent.ThreadFactoryImpl$ManagedThreadRunnable.run(ThreadFactoryImpl.java:61)
Caused by: java.lang.IllegalStateException: Corrupt serialized resolution result. Cannot find selected module (13) for compile -> jakarta.activation:jakarta.activation-api:1.2.1
